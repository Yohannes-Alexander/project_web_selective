...
@section('content')
    <div class="banner">
        <div class="owl-four owl-carousel" itemprop="image">
            <img src="https://source.unsplash.com/1366x600/?cafe" alt="Image of Bannner">
            <img src="https://source.unsplash.com/1366x600/?coffeshop" alt="Image of Bannner">
            <img src="https://source.unsplash.com/1366x600/?restaurant" alt="Image of Bannner">
        </div>
    ...
    <section class="about-upper-section" itemprop="mainContentofPage">
        <div class="container">
            <article class="who-we-are">
                ...
                <p>Selective Coffee is a Roastery based in South Jakarta that focuses on selling roasted bean selection with developed roasting techniques to provide the best coffee tastes with affordable price to all society levels.</p>

                <p>Selective are meant to provide the finest selected beans. We carefully choose coffee beans as being the best or most suitable with technically development roasting to taking out all the potential the spectrum flavor of coffee taste.</p>

                <p>We began by detailing issues with our technic roasting in order to serve a good cup of coffee.</p>
            </article>
            <div class="our-story">
                <h2 class="top-heading">our story</h2>
                <ul>
                    <li><i class="fas fa-chalkboard-teacher"></i> <a href="#">Affordable</a></li>
                    <li><i class="fas fa-graduation-cap"></i> <a href="#">Clean</a></li>
                    <li><i class="fas fa-book-open"></i> <a href="#">The best choice</a></li>
                    <li><i class="fas fa-users"></i> <a href="#">Convenient</a></li>
        ...
        <div class="container">
            ...
            <article class="developer-grid">
                <div class="developer-wrap">
                    <img src="template/edulab/images/developer-img.jpg" alt="developer images">
                    <h3>Bibek Basnet</h3>
                    <p>Founder</p>
                    <ul>
                ...
                <div class="developer-wrap">
                    <img src="template/edulab/images/developer-img.jpg" alt="developer images">
                    <h3>Alexander</h3>
                    <p>Head of Human Resource Management</p>
                    <ul>
                        <li><a href=""><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href=""><i class="fab fa-instagram"></i></a></li>
                        <li><a href=""><i class="fab fa-twitter"></i></a></li>
                ...
                <div class="developer-wrap">
                    <img src="template/edulab/images/developer-img.jpg" alt="developer images">
                    <h3>Jeffrey</h3>
                    <p>Head of Information Techology</p>
                    <ul>
                        <li><a href=""><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href=""><i class="fab fa-instagram"></i></a></li>
                        <li><a href=""><i class="fab fa-twitter"></i></a></li>
