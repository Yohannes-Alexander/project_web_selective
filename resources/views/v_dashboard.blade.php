...
<div class="wrapper">
  ...
  <div class="content-wrapper"><br>
      <div>
        &nbsp;&nbsp;<a href="" class="btn btn-primary btm-sm">Add</a><br>
      </div>
      <br>
      <table class="table table-bordered">
        ...
        <tbody>
            <td>1</td>
            <td>Ilham Nur Akbar</td>
            <td>ilham.nur.akbar-2020@fst.unair.ac.id</td>
            <td>Kelapa Gading</td>
            <td>Barista</td>
            <td>Tolong terima saya</td>
            <td><img src="template/edulab/images/ilham.png"></td>
            <td>
